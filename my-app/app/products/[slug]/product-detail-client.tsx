...
export default function ProductsClient({ initialProducts, initialCategories }: ProductsClientProps) {
    ...
    const filteredProducts = useMemo(() => {
        ...
        return products
    }, [searchQuery, selectedCategory, sortBy, priceRange, showOnlyInStock, showOnlyNew, initialProducts])
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2">
                                ...
                                <div className="p-6 flex flex-col">
                                    ...
                                    <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
                                        Experience the premium quality of our {product.name}.
                                        Carefully formulated to enhance your natural beauty and
